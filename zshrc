...
alias pd='tmuxinator start prydev'
alias pdkill='tmuxinator stop prydev'
alias db='bin/db'
alias fmt='standardrb --fix; erblint . -a; yarn format'
alias u='bin/env_update'
alias c='bin/console'
alias fresh='bin/fresh --with-ffs'
